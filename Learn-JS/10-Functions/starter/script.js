...
// // console.log(upperFirstWord('hihihi thong'));
...
//   return function () {
//     passengerC++;
//     console.log(`${passengerC} passenger`);
//   };
// };
...
//   setTimeout(function () {
//     console.log(`test ${n} passengers`);
//     console.log(`There are 3 group, eacch with ${perGroup} passengers`);
//   }, wait * 3000);
